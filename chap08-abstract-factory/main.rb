...
class Main
  def main(classname, filename)
    ...
    asashi = factory.create_link('Asahi', 'https://www.asashi.com')
    yomiuri = factory.create_link('Yomiuri', 'https://www.yomiuri.co.jp')
    ...
    page = factory.create_page(filename, 'Ichiro Suzuki')
    page.add(traynews)
    page.add(traysearch)
    page.output
  end
